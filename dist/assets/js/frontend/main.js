document.addEventListener("DOMContentLoaded", function () {
    ...
    // 側邊欄
    if (document.querySelector(".site_aside")) {
        ...
        // const selectedItem = xinyaoJs.getSelectedItem();
        // xinyaoJs.log("selectedItem", selectedItem);
        // cart_num.innerHTML = selectedItem.length;
    }
